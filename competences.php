...
<form method="POST">
  <div class="container">
    <p class="faire">Veuillez saisir votre niveau dans les domaines suivants puis valider.</p>
    <h4 style='color: grey; margin-bottom: 9%; text-align: center;'>(Vous pouvez à tout moment mettre votre niveau à jour depuis votre page de profil)</h4>
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp0" id="st1" value="5" />
              <input type="hidden" name="id_comp_hc" value="13"/>
              <label for="st1"></label>
              <input type="checkbox" name="niv_comp0" id="st2" value="4" />
              <input type="hidden" name="id_comp_hc" value="13"/>
              <label for="st2"></label>
              <input type="checkbox" name="niv_comp0" id="st3" value="3" />
              <input type="hidden" name="id_comp_hc" value="13"/>
              <label for="st3"></label>
              <input type="checkbox" name="niv_comp0" id="st4" value="2" />
              <input type="hidden" name="id_comp_hc" value="13"/>
              <label for="st4"></label>
              <input type="checkbox" name="niv_comp0" id="st5" value="1" />
              <input type="hidden" name="id_comp_hc" value="13"/>
              <label for="st5"></label>
            </div>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image ">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp1" id="st1-1" value="5" />
              <input type="hidden" name="id_comp_php" value="20"/>
              <label for="st1-1"></label>
              <input type="checkbox" name="niv_comp1" id="st2-1" value="4" />
              <input type="hidden" name="id_comp_php" value="20"/>
              <label for="st2-1"></label>
              <input type="checkbox" name="niv_comp1" id="st3-1" value="3" />
              <input type="hidden" name="id_comp_php" value="20"/>
              <label for="st3-1"></label>
              <input type="checkbox" name="niv_comp1" id="st4-1" value="2" />
              <input type="hidden" name="id_comp_php" value="20"/>
              <label for="st4-1"></label>
              <input type="checkbox" name="niv_comp1" id="st5-1" value="1" />
              <input type="hidden" name="id_comp_php" value="20"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp2" id="st1-2" value="5" />
              <input type="hidden" name="id_comp_js" value="15"/>
              <label for="st1-2"></label>
              <input type="checkbox" name="niv_comp2" id="st2-2" value="4" />
              <input type="hidden" name="id_comp_js" value="15"/>
              <label for="st2-2"></label>
              <input type="checkbox" name="niv_comp2" id="st3-2" value="3" />
              <input type="hidden" name="id_comp_js" value="15"/>
              <label for="st3-2"></label>
              <input type="checkbox" name="niv_comp2" id="st4-2" value="2" />
              <input type="hidden" name="id_comp_js" value="15"/>
              <label for="st4-2"></label>
              <input type="checkbox" name="niv_comp2" id="st5-2" value="1" />
              <input type="hidden" name="id_comp_js" value="15"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp3" id="st1-3" value="5" />
              <input type="hidden" name="id_comp_bdd" value="6"/>
              <label for="st1-3"></label>
              <input type="checkbox" name="niv_comp3" id="st2-3" value="4" />
              <input type="hidden" name="id_comp_bdd" value="6"/>
              <label for="st2-3"></label>
              <input type="checkbox" name="niv_comp3" id="st3-3" value="3" />
              <input type="hidden" name="id_comp_bdd" value="6"/>
              <label for="st3-3"></label>
              <input type="checkbox" name="niv_comp3" id="st4-3" value="2" />
              <input type="hidden" name="id_comp_bdd" value="6"/>
              <label for="st4-3"></label>
              <input type="checkbox" name="niv_comp3" id="st5-3" value="1" />
              <input type="hidden" name="id_comp_bdd" value="6"/>
        ...
        <div class="item">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp4" id="st1-4" value="5" />
              <input type="hidden" name="id_comp_ccpp" value="8"/>
              <label for="st1-4"></label>
              <input type="checkbox" name="niv_comp4" id="st2-4" value="4" />
              <input type="hidden" name="id_comp_ccpp" value="8"/>
              <label for="st2-4"></label>
              <input type="checkbox" name="niv_comp4" id="st3-4" value="3" />
              <input type="hidden" name="id_comp_ccpp" value="8"/>
              <label for="st3-4"></label>
              <input type="checkbox" name="niv_comp4" id="st4-4" value="2" />
              <input type="hidden" name="id_comp_ccpp" value="8"/>
              <label for="st4-4"></label>
              <input type="checkbox" name="niv_comp4" id="st5-4" value="1" />
              <input type="hidden" name="id_comp_ccpp" value="8"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp5" id="st1-5" value="5" />
              <input type="hidden" name="id_comp_csh" value="9"/>
              <label for="st1-5"></label>
              <input type="checkbox" name="niv_comp5" id="st2-5" value="4" />
              <input type="hidden" name="id_comp_csh" value="9"/>
              <label for="st2-5"></label>
              <input type="checkbox" name="niv_comp5" id="st3-5" value="3" />
              <input type="hidden" name="id_comp_csh" value="9"/>
              <label for="st3-5"></label>
              <input type="checkbox" name="niv_comp5" id="st4-5" value="2" />
              <input type="hidden" name="id_comp_csh" value="9"/>
              <label for="st4-5"></label>
              <input type="checkbox" name="niv_comp5" id="st5-5" value="1" />
              <input type="hidden" name="id_comp_csh" value="9"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp6" id="st1-6" value="5" />
              <input type="hidden" name="id_comp_py" value="22"/>
              <label for="st1-6"></label>
              <input type="checkbox" name="niv_comp6" id="st2-6" value="4" />
              <input type="hidden" name="id_comp_py" value="22"/>
              <label for="st2-6"></label>
              <input type="checkbox" name="niv_comp6" id="st3-6" value="3" />
              <input type="hidden" name="id_comp_py" value="22"/>
              <label for="st3-6"></label>
              <input type="checkbox" name="niv_comp6" id="st4-6" value="2" />
              <input type="hidden" name="id_comp_py" value="22"/>
              <label for="st4-6"></label>
              <input type="checkbox" name="niv_comp6" id="st5-6" value="1" />
              <input type="hidden" name="id_comp_py" value="22"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp7" id="st1-7" value="5" />
              <input type="hidden" name="id_comp_bat" value="5"/>
              <label for="st1-7"></label>
              <input type="checkbox" name="niv_comp7" id="st2-7" value="4" />
              <input type="hidden" name="id_comp_bat" value="5"/>
              <label for="st2-7"></label>
              <input type="checkbox" name="niv_comp7" id="st3-7" value="3" />
              <input type="hidden" name="id_comp_bat" value="5"/>
              <label for="st3-7"></label>
              <input type="checkbox" name="niv_comp7" id="st4-7" value="2" />
              <input type="hidden" name="id_comp_bat" value="5"/>
              <label for="st4-7"></label>
              <input type="checkbox" name="niv_comp7" id="st5-7" value="1" />
              <input type="hidden" name="id_comp_bat" value="5"/>
        ...
        <div class="item">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp8" id="st1-8" value="5" />
              <input type="hidden" name="id_comp_perl" value="19"/>
              <label for="st1-8"></label>
              <input type="checkbox" name="niv_comp8" id="st2-8" value="4" />
              <input type="hidden" name="id_comp_perl" value="19"/>
              <label for="st2-8"></label>
              <input type="checkbox" name="niv_comp8" id="st3-8" value="3" />
              <input type="hidden" name="id_comp_perl" value="19"/>
              <label for="st3-8"></label>
              <input type="checkbox" name="niv_comp8" id="st4-8" value="2" />
              <input type="hidden" name="id_comp_perl" value="19"/>
              <label for="st4-8"></label>
              <input type="checkbox" name="niv_comp8" id="st5-8" value="1" />
              <input type="hidden" name="id_comp_perl" value="19"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp9" id="st1-9" value="5" />
              <input type="hidden" name="id_comp_ruby" value="25"/>
              <label for="st1-9"></label>
              <input type="checkbox" name="niv_comp9" id="st2-9" value="4" />
              <input type="hidden" name="id_comp_ruby" value="25"/>
              <label for="st2-9"></label>
              <input type="checkbox" name="niv_comp9" id="st3-9" value="3" />
              <input type="hidden" name="id_comp_ruby" value="25"/>
              <label for="st3-9"></label>
              <input type="checkbox" name="niv_comp9" id="st4-9" value="2" />
              <input type="hidden" name="id_comp_ruby" value="25"/>
              <label for="st4-9"></label>
              <input type="checkbox" name="niv_comp9" id="st5-9" value="1" />
              <input type="hidden" name="id_comp_ruby" value="25"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp10" id="st1-10" value="5" />
              <input type="hidden" name="id_comp_vb" value="28"/>
              <label for="st1-10"></label>
              <input type="checkbox" name="niv_comp10" id="st2-10" value="4" />
              <input type="hidden" name="id_comp_vb" value="28"/>
              <label for="st2-10"></label>
              <input type="checkbox" name="niv_comp10" id="st3-10" value="3" />
              <input type="hidden" name="id_comp_vb" value="28"/>
              <label for="st3-10"></label>
              <input type="checkbox" name="niv_comp10" id="st4-10" value="2" />
              <input type="hidden" name="id_comp_vb" value="28"/>
              <label for="st4-10"></label>
              <input type="checkbox" name="niv_comp10" id="st5-10" value="1" />
              <input type="hidden" name="id_comp_vb" value="28"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp11" id="st1-11" value="5" />
              <input type="hidden" name="id_comp_jsf" value="23"/>
              <label for="st1-11"></label>
              <input type="checkbox" name="niv_comp11" id="st2-11" value="4" />
              <input type="hidden" name="id_comp_jsf" value="23"/>
              <label for="st2-11"></label>
              <input type="checkbox" name="niv_comp11" id="st3-11" value="3" />
              <input type="hidden" name="id_comp_jsf" value="23"/>
              <label for="st3-11"></label>
              <input type="checkbox" name="niv_comp11" id="st4-11" value="2" />
              <input type="hidden" name="id_comp_jsf" value="23"/>
              <label for="st4-11"></label>
              <input type="checkbox" name="niv_comp11" id="st5-11" value="1" />
              <input type="hidden" name="id_comp_jsf" value="23"/>
        ...
        <div class="item">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp12" id="st1-12" value="5" />
              <input type="hidden" name="id_comp_phpf" value="21"/>
              <label for="st1-12"></label>
              <input type="checkbox" name="niv_comp12" id="st2-12" value="4" />
              <input type="hidden" name="id_comp_phpf" value="21"/>
              <label for="st2-12"></label>
              <input type="checkbox" name="niv_comp12" id="st3-12" value="3" />
              <input type="hidden" name="id_comp_phpf" value="21"/>
              <label for="st3-12"></label>
              <input type="checkbox" name="niv_comp12" id="st4-12" value="2" />
              <input type="hidden" name="id_comp_phpf" value="21"/>
              <label for="st4-12"></label>
              <input type="checkbox" name="niv_comp12" id="st5-12" value="1" />
              <input type="hidden" name="id_comp_phpf" value="21"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp13" id="st1-13" value="5" />
              <input type="hidden" name="id_comp_linux" value="16"/>
              <label for="st1-13"></label>
              <input type="checkbox" name="niv_comp13" id="st2-13" value="4" />
              <input type="hidden" name="id_comp_linux" value="16"/>
              <label for="st2-13"></label>
              <input type="checkbox" name="niv_comp13" id="st3-13" value="3" />
              <input type="hidden" name="id_comp_linux" value="16"/>
              <label for="st3-13"></label>
              <input type="checkbox" name="niv_comp13" id="st4-13" value="2" />
              <input type="hidden" name="id_comp_linux" value="16"/>
              <label for="st4-13"></label>
              <input type="checkbox" name="niv_comp13" id="st5-13" value="1" />
              <input type="hidden" name="id_comp_linux" value="16"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp14" id="st1-14" value="5" />
              <input type="hidden" name="id_comp_win" value="29"/>
              <label for="st1-14"></label>
              <input type="checkbox" name="niv_comp14" id="st2-14" value="4" />
              <input type="hidden" name="id_comp_win" value="29"/>
              <label for="st2-14"></label>
              <input type="checkbox" name="niv_comp14" id="st3-14" value="3" />
              <input type="hidden" name="id_comp_win" value="29"/>
              <label for="st3-14"></label>
              <input type="checkbox" name="niv_comp14" id="st4-14" value="2" />
              <input type="hidden" name="id_comp_win" value="29"/>
              <label for="st4-14"></label>
              <input type="checkbox" name="niv_comp14" id="st5-14" value="1" />
              <input type="hidden" name="id_comp_win" value="29"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp15" id="st1-15" value="5" />
              <input type="hidden" name="id_comp_appmobile" value="4"/>
              <label for="st1-15"></label>
              <input type="checkbox" name="niv_comp15" id="st2-15" value="4" />
              <input type="hidden" name="id_comp_appmobile" value="4"/>
              <label for="st2-15"></label>
              <input type="checkbox" name="niv_comp15" id="st3-15" value="3" />
              <input type="hidden" name="id_comp_appmobile" value="4"/>
              <label for="st3-15"></label>
              <input type="checkbox" name="niv_comp15" id="st4-15" value="2" />
              <input type="hidden" name="id_comp_appmobile" value="4"/>
              <label for="st4-15"></label>
              <input type="checkbox" name="niv_comp15" id="st5-15" value="1" />
              <input type="hidden" name="id_comp_appmobile" value="4"/>
        ...
        <div class="item">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp16" id="sti-16" value="5" />
              <input type="hidden" name="id_comp_ang" value="3"/>
              <label for="st1-16"></label>
              <input type="checkbox" name="niv_comp16" id="st2-16" value="4" />
              <input type="hidden" name="id_comp_ang" value="3"/>
              <label for="st2-16"></label>
              <input type="checkbox" name="niv_comp16" id="st3-16" value="3" />
              <input type="hidden" name="id_comp_ang" value="3"/>
              <label for="st3-16"></label>
              <input type="checkbox" name="niv_comp16" id="st4-16" value="2" />
              <input type="hidden" name="id_comp_ang" value="3"/>
              <label for="st4-16"></label>
              <input type="checkbox" name="niv_comp16" id="st5-16" value="1" />
              <input type="hidden" name="id_comp_ang" value="3"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp17" id="st1-17" value="5" />
              <input type="hidden" name="id_comp_fran" value="12"/>
              <label for="st1-17"></label>
              <input type="checkbox" name="niv_comp17" id="st2-17" value="4" />
              <input type="hidden" name="id_comp_fran" value="12"/>
              <label for="st2-17"></label>
              <input type="checkbox" name="niv_comp17" id="st3-17" value="3" />
              <input type="hidden" name="id_comp_fran" value="12"/>
              <label for="st3-17"></label>
              <input type="checkbox" name="niv_comp17" id="st4-17" value="2" />
              <input type="hidden" name="id_comp_fran" value="12"/>
              <label for="st4-17"></label>
              <input type="checkbox" name="niv_comp17" id="st5-17" value="1" />
              <input type="hidden" name="id_comp_fran" value="12"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp18" id="st1-18" value="5" />
              <input type="hidden" name="id_comp_maths" value="18"/>
              <label for="st1-18"></label>
              <input type="checkbox" name="niv_comp18" id="st2-18" value="4" />
              <input type="hidden" name="id_comp_maths" value="18"/>
              <label for="st2-18"></label>
              <input type="checkbox" name="niv_comp18" id="st3-18" value="3" />
              <input type="hidden" name="id_comp_maths" value="18"/>
              <label for="st3-18"></label>
              <input type="checkbox" name="niv_comp18" id="st4-18" value="2" />
              <input type="hidden" name="id_comp_maths" value="18"/>
              <label for="st4-18"></label>
              <input type="checkbox" name="niv_comp18" id="st5-18" value="1" />
              <input type="hidden" name="id_comp_maths" value="18"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp19" id="st1-19" value="5" />
              <input type="hidden" name="id_comp_algo" value="4"/>
              <label for="st1-19"></label>
              <input type="checkbox" name="niv_comp19" id="st2-19" value="4" />
              <input type="hidden" name="id_comp_algo" value="4"/>
              <label for="st2-19"></label>
              <input type="checkbox" name="niv_comp19" id="st3-19" value="3" />
              <input type="hidden" name="id_comp_algo" value="4"/>
              <label for="st3-19"></label>
              <input type="checkbox" name="niv_comp19" id="st4-19" value="2" />
              <input type="hidden" name="id_comp_algo" value="4"/>
              <label for="st4-19"></label>
              <input type="checkbox" name="niv_comp19" id="st5-19" value="1" />
              <input type="hidden" name="id_comp_algo" value="4"/>
        ...
        <div class="item">
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp20" id="st1-20" value="5" />
              <input type="hidden" name="id_comp_res" value="24"/>
              <label for="st1-20"></label>
              <input type="checkbox" name="niv_comp20" id="st2-20" value="4" />
              <input type="hidden" name="id_comp_res" value="24"/>
              <label for="st2-20"></label>
              <input type="checkbox" name="niv_comp20" id="st3-20" value="3" />
              <input type="hidden" name="id_comp_res" value="24"/>
              <label for="st3-20"></label>
              <input type="checkbox" name="niv_comp20" id="st4-20" value="2" />
              <input type="hidden" name="id_comp_res" value="24"/>
              <label for="st4-20"></label>
              <input type="checkbox" name="niv_comp20" id="st5-20" value="1" />
              <input type="hidden" name="id_comp_res" value="24"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp21" id="st1-21" value="5" />
              <input type="hidden" name="id_comp_mag" value="17"/>
              <label for="st1-21"></label>
              <input type="checkbox" name="niv_comp21" id="st2-21" value="4" />
              <input type="hidden" name="id_comp_mag" value="17"/>
          ...
          <div class="col-md-2 col-lg-2 col-xs-8 col-sm-8 image">
            ...
            <div class="wrapper">
              <input type="checkbox" name="niv_comp22" id="st1-22" value="5" />
              <input type="hidden" name="id_comp_eco" value="11"/>
              <label for="st1-22"></label>
              <input type="checkbox" name="niv_comp22" id="st2-22" value="4" />
              <input type="hidden" name="id_comp_eco" value="11"/>
              <label for="st2-22"></label>
              <input type="checkbox" name="niv_comp22" id="st3-22" value="3" />
              <input type="hidden" name="id_comp_eco" value="11"/>
              <label for="st3-22"></label>
              <input type="checkbox" name="niv_comp22" id="st4-22" value="2" />
              <input type="hidden" name="id_comp_eco" value="11"/>
              <label for="st4-22"></label>
              <input type="checkbox" name="niv_comp22" id="st5-22" value="1" />
              <input type="hidden" name="id_comp_eco" value="11"/>
