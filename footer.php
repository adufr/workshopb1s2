    ...
    <div class="container">
      <div class="row">
        <div class=".col-md-6 .offset-md-3 text-center">
          ...
          <p>Etudiant à l'Epsi, nous avons créé ce site à la suite d'un projet National entre les différents campus Epsien.
            Site créé par Ariana Montignac, Ambrine Quintana, Alexandre Tuet, Arthur Dufour </p>
        </div>
      </div>
    </div>
  </div>
